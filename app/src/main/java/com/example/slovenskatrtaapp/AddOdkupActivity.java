...
public class AddOdkupActivity extends AppCompatActivity {
    ...
    private String url = "https://slovenskatrta-is.azurewebsites.net/api/v1/Odkup";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_odkup);
        id = (EditText) findViewById(R.id.tePridelekId);
        kolicina = (EditText) findViewById(R.id.teKolicina);
        cena = (EditText) findViewById(R.id.teCenaNaKg);
    ...
    public void addVinograd(View view){
        ...
        try {
            ...
            jsonBody.put("pridelekId", id.getText());
            jsonBody.put("kolicina", kolicina.getText());
            jsonBody.put("cenaNaKg", cena.getText());
